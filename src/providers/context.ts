 ...
 * means none). The bus does no context management, so optimization lives
 * here. A consumer needing more than a window (rolling summaries in the style
 * of Semantic Kernel's chat-history reduction, relevance filtering, ...)
